...
public class NextDayCalculator {
    ...
    static String findNextDay(int day, int month, int year) {
        ...
        } else if (day == lastDayOfMonth(month, year) && month >= FIRST_MONTH && month < LAST_MONTH) {
            return FIRST_DAY + "/" + ++month + "/" + year;
        } else if (day >= FIRST_DAY && day < lastDayOfMonth(month, year) && month >= FIRST_MONTH && month <= LAST_MONTH) {
